...
import { useCalendarEvents } from '@/hooks/useInterviews';
...
export const InterviewCalendar: React.FC<InterviewCalendarProps> = ({ className }) => {
        ...
        <CardContent>
          <div className="grid grid-cols-7 gap-2 mb-4">
            {['L', 'M', 'M', 'J', 'V', 'S', 'D'].map((day, index) => (
              <div key={index} className="text-center font-medium text-gray-500 text-sm p-2">
                {day}
              </div>
            ))}
          </div>
      ...
      <Card className={className}>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Button variant="outline" size="sm" onClick={() => navigate.push('/interviews/new')}>
        ...
        <CardContent>
                      ...
                      <Tooltip key={event.id}>
                        <TooltipTrigger asChild>
                          <div
                            ...
                            onClick={() => navigate.push(`/interviews/${event.id}`)}
                          >
                        ...
                        <TooltipContent side="top" className="max-w-xs">
                          <div className="space-y-1">
                            ...
                            <div className="text-sm">{event.position} chez {event.company}</div>
          ...
          <div className="mt-6 pt-4 border-t">
            <h4 className="text-sm font-medium text-gray-700 mb-3">Types d&apos;entretiens</h4>
          ...
          {events && events.length > 0 && (
            <div className="mt-4 pt-4 border-t">
              <h4 className="text-sm font-medium text-gray-700 mb-3">
                Ce mois-ci ({events.length} entretien{events.length > 1 ? 's' : ''})
              </h4>
